...
| [`transform`](transform.md) | Affine transforms: drawing in local coordinates. | 20 |
| [`rig`](rig.md) | Figures as parts in a tree: pose them, name points on them, rasterise once. | 21 |
...
- [`Rig::has`](rig.md#righas): a predicate
