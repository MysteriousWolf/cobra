...
[Index](README.md) · [canvas](canvas.md) · [draw](draw.md) · [path](path.md) · [layer](layer.md) · [bubble](bubble.md) · [font](font.md) · [text](text.md) · [color](color.md) · [render](render.md) · [term](term.md) · [export](export.md) · [ratatui](ratatui.md)
...
|---|---|---|
| [`canvas`](canvas.md) | The dot grid: cells, dots, colours per dot. | 24 |
| [`draw`](draw.md) | Shapes, strokes, paints, patterns, gradients, shaders and masks. | 59 |
| [`path`](path.md) | Outlines from lines, curves and arcs, filled or stroked. | 20 |
| [`layer`](layer.md) | Stacked canvases, mattes, and effects around silhouettes. | 36 |
...
shader of your own. The result is a plain [`Canvas`](canvas.md#canvas), which every protocol and
exporter takes as usual; in the text fallback a cell takes the colour of the
topmost layer in it. See the [`layer`](layer.md) module.
